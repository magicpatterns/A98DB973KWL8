  ...
  return (
    <table
      ...
      className={cn(
        'localize' + '-table',
        {
          ['localize' + '-table-alignment-' + alignment]:
            !!alignment,
        },
        'localize' + '-table-variant-' + variant,
        className
      )}
      style={style}
      {...props}
...
export function TableHeaderCell({
  ...
  return (
    <th
      ...
      {...props}
    >
      <div className={cn('localize' + '-table-cell-content')}>
        {children}
        {sortIcon && (
          <FontAwesomeIcon
            icon={sortIcon}
            className={
              'localize' + '-table-header-cell-icon-sort'
            }
...
function TableExpandableRowHeader({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      className={cn('localize' + '-table-expandable-row-header')}
    >
      <div
        className={cn('localize' + '-table-expandable-row-icon')}
        onClick={() => {
          if (setIsExpanded) {
...
function TableExpandableRowPanel({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <div
        className={cn('localize' + '-table-expandable-row-panel')}
      >
        <div
          className={cn(
    ...
    <td
      ...
      className={cn(
        'localize' + '-table-cell',
        {
          ['localize' + '-table-alignment-' + alignment]:
            !!alignment,
          ['localize' + '-table-cell-width-nowrap']:
            width === 'nowrap',
        },
        className
      )}
      ...
      {...props}
    >
      <div className={'localize' + '-table-cell-content'}>
        {checkbox && (
          <div
            className={cn('localize' + '-table-cell-checkbox', {
              ['localize' + '-table-cell-checkbox-separator']:
                separator,
            })}
          >
            <Checkbox />
...
export function TableFooter({
  ...
  return (
    <tfoot
      className={cn('localize' + '-table-footer', className)}
      style={style}
      ref={ref}
      {...props}
    >
