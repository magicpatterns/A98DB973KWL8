...
function DatePickerRangeButton({
  ...
  return (
    <button
      className={cn('localize' + '-datePicker-range-button', {
        ['localize' + '-datePicker-range-button-selected']:
          isSelected,
      })}
      onClick={onClick}
    >
    ...
    <Popover>
      <PopoverTrigger>
        ...
        >
          ...
          <span
            className={cn('localize' + '-datePicker-button-text')}
          >
            {renderValue()}
          </span>
        </button>
      ...
      <PopoverContent>
        <div className={cn('localize' + '-datePicker-content')}>
